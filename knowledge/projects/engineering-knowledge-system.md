...
- 9,660 objective assertions check response contracts, source selection, citation safety, required and forbidden language, readable Markdown, output bounds, navigation, and expected retrieval or generation calls.
...
- A committed offline evaluation result that currently records 552 of 552 cases and 9,660 of 9,660 objective assertions passing.
