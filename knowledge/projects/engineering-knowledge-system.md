...
- 542 labelled cases combine 72 focused regressions with 470 persona questions: 100 recruiter, 100 student, 100 curious visitor, 10 spouse, 100 colleague, and 60 founder prompts.
- 9,366 objective assertions check response contracts, source selection, citation safety, required and forbidden language, readable Markdown, output bounds, navigation, and expected retrieval or generation calls.
...
- A committed offline evaluation result that currently records 542 of 542 cases and 9,366 of 9,366 objective assertions passing.
