...
- 553 labelled cases combine 73 focused regressions with 480 persona questions: 110 recruiter, 100 student, 100 curious visitor, 10 spouse, 100 colleague, and 60 founder prompts.
- 9,701 objective assertions check response contracts, source selection, citation safety, required and forbidden language, readable Markdown, output bounds, navigation, and expected retrieval or generation calls.
...
- A committed offline evaluation result that currently records 553 of 553 cases and 9,701 of 9,701 objective assertions passing.
