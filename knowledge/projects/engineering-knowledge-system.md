...
- 9,678 objective assertions check response contracts, source selection, citation safety, required and forbidden language, readable Markdown, output bounds, navigation, and expected retrieval or generation calls.
...
- A committed offline evaluation result that currently records 553 of 553 cases and 9,678 of 9,678 objective assertions passing.
