...
- 541 labelled cases combine 71 focused regressions with 470 persona questions: 100 recruiter, 100 student, 100 curious visitor, 10 spouse, 100 colleague, and 60 founder prompts.
- 9,344 objective assertions check response contracts, source selection, citation safety, required and forbidden language, readable Markdown, output bounds, navigation, and expected retrieval or generation calls.
