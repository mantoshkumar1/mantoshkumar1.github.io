...
- 552 labelled Ask Mantosh evaluation cases with 9,660 objective assertions covering 72 focused regressions plus recruiter, student, curious-visitor, spouse, colleague, and founder questions across social, navigation, unsupported, achievement, ownership, grounded-answer, and adversarial behavior;
