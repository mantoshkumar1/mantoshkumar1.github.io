...
Last verified Worker deployment: `d3816844-2c99-4b25-92b4-c7786338479c`. The active answer-policy cache namespace is `visitor-intent-v39-complete-ownership`.
...
- 552 labelled Ask Mantosh evaluation cases with 9,616 objective assertions covering 72 focused regressions plus recruiter, student, curious-visitor, spouse, colleague, and founder questions across social, navigation, unsupported, achievement, ownership, grounded-answer, and adversarial behavior;
