...
10. [`BACKLOG.md`](BACKLOG.md) records planned work that is not yet built. Nothing in it is published or claimed; an item leaves only when working evidence exists.
