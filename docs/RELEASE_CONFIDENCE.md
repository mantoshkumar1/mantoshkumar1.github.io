...
Every pull request runs the deterministic static audits, 55 Worker tests, the 528-case Ask Mantosh evaluation, and 14 browser checks: seven visitor journeys in desktop Chromium and a mobile Chromium viewport.
...
At the time this document was updated, the measured maxima were 20,236-byte HTML, 75,767-byte CSS, 33,351 bytes of JavaScript, and a 546,053-byte public artifact excluding the PDF.
