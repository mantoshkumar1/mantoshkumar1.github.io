...
At the time this document was updated, the measured maxima were 25,835-byte HTML, 82,779-byte CSS, 42,768 bytes of JavaScript, and a 599,966-byte public artifact excluding the PDF.
