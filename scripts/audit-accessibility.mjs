...
if (!/AI answer limits: 5 per minute and 50 per UTC day, shared across visitors/.test(widget)) failures.push("Ask Mantosh must disclose its shared AI allowance");
