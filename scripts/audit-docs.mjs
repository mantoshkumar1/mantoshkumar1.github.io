...
const configuredValues = [
  ...
  "ask-mantosh-knowledge-v3", "MAX_OUTPUT_TOKENS = \"450\"", "FREE_DAILY_REQUEST_LIMIT = \"300\"",
...
for (const value of ["@cf/meta/llama-3.1-8b-instruct-fast", "@cf/baai/bge-m3", "personal-website-knowledge", "ask-mantosh-knowledge-v3", "450", "300", "20 requests per minute", "24-hour session TTL"]) {
