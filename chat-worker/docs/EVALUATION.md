...
All **554 of 554 cases** and **9,734 of 9,734 objective assertions** pass in [`../eval/results/latest.json`](../eval/results/latest.json). The 554 labelled cases combine 74 focused regressions with 480 recruiter, student, curious visitor, spouse, colleague, and founder questions. The spouse persona adds plain-language, playful, skeptical, and typo-tolerant questions from a visitor who does not know Mantosh's work.
