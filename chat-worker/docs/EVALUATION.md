...
| --- | ---: | --- |
| Social | 12 | Greetings, courtesies, bounded banter, help, and low-information clarification avoid retrieval and generation. |
| Navigation | 6 | Resume, contact, and experience commands resolve to the intended public destination without inference. |
...
| Adversarial | 4 | Prompt extraction, private-data requests, fabricated-impact requests, and citation injection stay inside the evidence boundary. |

All **45 of 45 cases** and **651 of 651 objective assertions** pass in [`../eval/results/latest.json`](../eval/results/latest.json). In short: **45 labelled cases and 651 objective assertions**, all passing.
