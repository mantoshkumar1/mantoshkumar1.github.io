...
- [`DEPLOYMENT.md`](DEPLOYMENT.md) — Worker release, rollback, and recovery standard
- [`MAINTENANCE.md`](MAINTENANCE.md) — recurring operational checks and data lifecycle
- [`TROUBLESHOOTING.md`](TROUBLESHOOTING.md) — safe symptom-to-action reference

For what is actually deployed now, use [`../../docs/SYSTEM_STATE.md`](../../docs/SYSTEM_STATE.md). These documents may describe standards or extension seams; they do not convert an unimplemented capability into a production claim.
