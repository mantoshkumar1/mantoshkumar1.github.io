...
export const SOURCE_FIXTURES = Object.freeze({
  ...
  "legacy-validation-framework-migration": fixture({
    ...
    content: "Mantosh led a two-person migration. He migrated the complete shared-library layer, integrated the distributed platform with CI/CD, built the migration dashboard, kept both frameworks aligned while development continued, coordinated the final comparison checks before the old framework was retired, and trained the receiving team. The second engineer primarily migrated individual test scripts.",
    answer: "## Personally owned\n- Led the two-person migration and integrated the distributed platform with CI/CD.\n- Migrated the complete shared-library layer and built the progress dashboard.\n- Kept both frameworks aligned, coordinated the final comparison checks, and trained the receiving team. [Project: Migrating a Legacy Framework Containing Thousands of Tests to a Distributed CI/CD Platform](/projects/legacy-validation-framework-migration.html)\n## Team context\nThe second engineer primarily migrated individual test scripts; together they migrated thousands of tests.\n## Sources\n- [Project: Migrating a Legacy Framework Containing Thousands of Tests to a Distributed CI/CD Platform](/projects/legacy-validation-framework-migration.html)"
  }),
