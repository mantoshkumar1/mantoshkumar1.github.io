...
const curious = [
  ...
  cases("curious", "challenge", ["Are you dumb?", "Are you stupid?", "Are you useless?", "You're dumb", "You are stupid", "This is nonsense", "That answer was useless", "Do you know anything?", "Why are you so dull?", "You failed that question"], { intent: "banter", expected: social(["specific question"]) }),
  ...
  cases("curious", "unsupported", ["Explain an unrelated quantum physics problem", "What's the weather today?", "Who will win the World Cup?", "Write my history homework", "Recommend a movie", "Tell me tomorrow's stock price", "Diagnose my headache", "Book me a flight", "Translate this novel", "Solve this unrelated crossword"], { intent: "out-of-scope", expected: refusal }),
