...
const curious = [
  ...
  cases("curious", "banter", ["lol", "Tell me a joke", "Make me laugh", "I'm bored", "What's up?", "Are you getting better?", "You're getting better", "Have you gotten better?", "You've improved", "That's better"], { intent: "banter", expected: social([]) }),
