...
const PROFILE_FACT_KEYS = new Set(["location", "time_zone", "citizenship", "work_authorization", "current_employer", "current_role", "employment_history", "experience_years", "target_roles", "capabilities", "skills"]);
