...
function normalizeGroundedAnswer(answer, followUpQuestions = []) {
  ...
  const firstHeading = normalized.search(/^##\s+(?:Answer|In brief|Highlights|Mantosh's ownership|Personally owned|What matters|Summary)\s*$/im);
